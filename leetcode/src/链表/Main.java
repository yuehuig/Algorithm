...
//		ListNode newHead = linkList.reverseList3(node0);
//		System.out.printf("list %d - %d - %d - %d - %d %n", newHead.val, newHead.next.val, newHead.next.next.val, newHead.next.next.next.val, newHead.next.next.next.next.val);
		...
		_19_删除链表的倒数第N个结点 linkList = new _19_删除链表的倒数第N个结点();
...
//		ListNode newHead = linkList.reverseList(node0);
		ListNode newHead = linkList.removeNthFromEnd(node0, 1);
		System.out.printf("list %d - %d - %d - %d %n", newHead.val, newHead.next.val, newHead.next.next.val, newHead.next.next.next.val);
